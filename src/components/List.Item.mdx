...
| add      | `(before?: ListItem<Fields>, value?: FormFieldValues<Fields>) => ListItemForm<Fields>` | Append a new item to the list. When called with the current item, it will prepend it.                      |
